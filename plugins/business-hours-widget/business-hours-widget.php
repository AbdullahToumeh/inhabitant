 ...
 * @copyright 2018 Dakota Mauza
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        https://github.com/DakotaPaige
 * Description:       Business Hours Widget, Business Hours
 * Version:           1.0.1
 * Author:            Dakota Mauza
 * Author URI:        https://github.com/DakotaPaige
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Widget to display the business hours in the sidebar'
			)
		);
